...
export function Footer() {
  return (
    <footer className="group flex justify-center items-center hover:underline text-neutral-100 dark:hover:text-white dark:bg-neutral-400 max-h-max text-sm pt-3 pb-safe">
